...
def index():
    ...
    db=pymysql.connect("localhost","flasktamsuser","flasktamsuser","logindb")
    cursor = db.cursor()
    form=LoginForm()
...
def register():
    if current_user.is_authenticated:
        ...
        if form.validate_on_submit():
            ...
            dba=pymysql.connect("localhost","flasktamsuser","flasktamsuser","logindb")
            cursor=dba.cursor()
